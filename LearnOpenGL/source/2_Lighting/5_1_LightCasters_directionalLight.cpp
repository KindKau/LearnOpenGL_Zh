...
// Light Pos
glm::vec3 lightPos = glm::vec3(1.0f, 5.0f, 1.5f);
...
int main()
{
	...
	//---------------------------Shader-------------------------------
	const char* vertexShaderPath = "G:/GitHub/OpenGL/LearnOpenGL_Zh/LearnOpenGL/Shaders/10_lightCaster_DirectionalLight.vs";
	const char* fragmentShaderPath = "G:/GitHub/OpenGL/LearnOpenGL_Zh/LearnOpenGL/Shaders/10_lightCaster_DirectionalLight.fs";
