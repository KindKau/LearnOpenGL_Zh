...
int main()
{
	...
	//---------------------------Shader-------------------------------
	const char* vertexShaderPath = "G:/GitHub/OpenGL/LearnOpenGL_Zh/LearnOpenGL/Shaders/4_colors.vs";
	const char* fragmentShaderPath = "G:/GitHub/OpenGL/LearnOpenGL_Zh/LearnOpenGL/Shaders/4_colors.fs";
	...
	OurShader.setVec3("objectColor", glm::vec3(1.0f, 0.5f, 0.3f));
	OurShader.setVec3("lightColor", glm::vec3(1.0f));
	
	LightShader.use();
	glm::mat4 lightModel;
	lightModel = glm::translate(lightModel, glm::vec3(0.0f, 3.0f, 2.0f));
