...
int main()
{
	...
	//---------------------------Shader-------------------------------
	const char* vertexShaderPath = "G:/GitHub/OpenGL/LearnOpenGL_Zh/LearnOpenGL/Shaders/11_lightCaster_PointLight.vs";
	const char* fragmentShaderPath = "G:/GitHub/OpenGL/LearnOpenGL_Zh/LearnOpenGL/Shaders/11_lightCaster_PointLight.fs";
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		OurShader.setFloat("light.linear", 0.07f);
		OurShader.setFloat("light.quadratic", 0.017f);
